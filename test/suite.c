...
int main()
{
	...
	cf_suite =
	    CU_add_suite("Create and free expression elements", NULL, NULL);
	...
	CU_add_test(cf_suite, "Create and free binary expression test",
		    test_binop_cf);
	axb_suite = CU_add_suite("a*x + b creation and access", NULL, NULL);
	CU_add_test(axb_suite, "Create, free and access a*x + b test",
		    test_create_access_axb);
	CU_add_test(axb_suite, "Bad a*x + b access test", test_bad_axb);
	calc_suite = CU_add_suite("Simple calculations", NULL, NULL);
	CU_add_test(calc_suite, "Simple and correct calculations",
		    test_calc_good);
	CU_add_test(calc_suite, "Bad calculations", test_calc_bad);
	canon_suite =
	    CU_add_suite("Canonical form, simple calculations", NULL, NULL);
	CU_add_test(canon_suite,
		    "Canonical form, simple and correct calculations",
		    test_canon_calc_good);
	CU_add_test(canon_suite, "Canonical form, bad calculations",
		    test_canon_calc_bad);
